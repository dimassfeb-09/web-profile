...
function CardPortfolio(props: Portfolio) {
    const {image_path, playstore, title, platform, github, tech, demo_live} = props;
                    ...
                    <div className="font-bold text-ellipsis">
                        ...
                        <span className="group/platform ml-1 inline-flex justify-center">
                            <span
                                ...
                                -translate-y-6 bg-black text-white text-xs p-1">{platform.toLowerCase()}</span>
                            <span>{platform == "mobile" ? <Android fontSize="small" className="text-green-700"/> :
                                <Public fontSize="small" className="text-blue-500"/>}</span>
                        </span>
                    </div>
                    <div className="flex">
                        {tech.map((v) => {
                            return (
                                ...
                                -translate-y-6 bg-black text-white text-xs p-1">{v}</span>
                                    <span><img
